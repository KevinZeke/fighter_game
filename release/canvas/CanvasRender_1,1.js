define(["require", "exports", "../component/Component"], function (require, exports, Component_1) {
    ...
    class CanvasRender {
        constructor() {
            this.event = new Component_1.EventListenTask();
            this.task = {};
            this.onceTaskList = [];
            this.taskName = [];
            this.timer = null;
        ...
        once(callback) {
            this.event.addOnceAsync(CanvasRender.ONCE_TASK_PREFIX + new Date().getTime(), callback);
            return this;
        }
        markEnd(callback) {
        ...
        addTop(taskName, taskCallback) {
            this.event.addTop(taskName, taskCallback);
            return this;
        }
        remove(name) {
